function toggleDescription() {
    ...
    var description = `
        ...
        Веб-орієнтований застосунок популярних фільмів і серіалів "Films&Serials"</p>

        <p><strong>Мета:</strong><br>
        Пришвидшений пошук фільмів, де користувачі зможуть переглядати популярні фільми та серіали онлайн, дізнаватися більше про кожен контент (опис, жанр, рік випуску), а також використовувати різні фільтри та категорії для зручного пошуку. Сайт повинен мати простий і зручний інтерфейс, який адаптується до різних типів пристроїв (десктопів, планшетів, смартфонів).</p>

        <p><strong>Опис предментого середовища:</strong></p>
        <p>Сайт є онлайн-платформою для пошуку та перегляду фільмів і серіалів. 
Він містить описи, трейлери, рейтинги, відгуки та дозволяє додавати улюблені матеріали до списку перегляду.</p>
